...
PUBLIC "-//BENTLEY//ELEMENTS DITA 1.1 Programming Domain//EN"
...
<!--                      attributes                               -->
<!--    2011.12.27 JTC: Add Bentley specialization elements        -->
<!-- ============================================================= -->
...
<!-- MicroStatoin keyword-specific elements -->
<!ENTITY % keyin		"keyin"										 >
...
<!ATTLIST  kwdchoice   %global-atts; class CDATA "+ topic/figgroup pr-d/kwdchoice " >
